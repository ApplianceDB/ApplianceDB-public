...
[![Full dataset: $999+](https://img.shields.io/badge/Full%20dataset-%24999%2B-F59E0B.svg)](#pricing)
...
| **Repair Intelligence Snapshot** | Full corpus · CSV + Parquet + SQLite · quarterly refresh | **$999** |
| **Enterprise Integration License** | Everything in Snapshot + commercial embedding rights (warranty / field-service platforms) · parts cross-reference tables · priority code-coverage requests | **$2,999** |

Both paid tiers include a commercial license (see [COMMERCIAL_LICENSE.md](COMMERCIAL_LICENSE.md)) and are delivered as a downloadable archive after invoicing.
